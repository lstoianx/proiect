...
public class OwnSongsAdapter extends RecyclerView.Adapter<OwnSongsAdapter.OwnSongsAdapterViewHolder> {

    Context context;
    List<Song> arrayListSongs;
    Song soong;

    public OwnSongsAdapter(Context context, List<Song> arrayListSongs){
    ...
    @NonNull
    @Override
    public OwnSongsAdapterViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.song_item,parent, false);
        return new OwnSongsAdapterViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull OwnSongsAdapterViewHolder holder, int position) {
    ...
    public class OwnSongsAdapterViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        TextView titleTxt, durationTxt;
        String link;

        public OwnSongsAdapterViewHolder(@NonNull View itemView) {
            super(itemView);
        ...
        public void onClick(View v) {
            ...
            ((ArtistActivity)context).playSong(getAdapterPosition());
        }
